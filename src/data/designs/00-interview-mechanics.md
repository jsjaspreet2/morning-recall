...
3. **Day 3 — say the page back out loud**, in full sentences, as though someone asked: §0's frame, the line in the header block about what's being graded, then each deep dive as its four beats — what you'd reach for, what breaks, what replaces it, what that costs. Work from the section headings alone. Out loud matters: fluent-in-your-head and fluent-out-loud are different skills, and only one of them is graded.
...
**Stop signal:** you can draw the skeleton in five minutes and talk through every deep dive without hesitation, twice on separate days. Then move on — re-reading a page you already know is the most comfortable and least useful thing available to you.
