...
export default function App() {
  ...
  // at every size. A guide or a design page is long-form reading with wide code
  // blocks and tables, so those get the desktop width — and only those, so
  // nothing else in the app reflows.
  ...
  return (
    <div
      className={[
        ...
        wide ? 'max-w-2xl xl:max-w-[88rem]' : 'max-w-2xl',
      ].join(' ')}
    >
