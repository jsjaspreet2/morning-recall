...
a.box(20, 240, 150, 64, "Devices", ["~1 B devices", "one WSS each"])
a.group(200, 86, 560, 130, "CONNECTION GATEWAYS — ~10 k NODES")
for x in (216, 396, 576):
    a.box(x, 118, 168, 64, "Gateway", ["holds sockets", "WSS · heartbeat TTL"])
...
a.box(520, 292, 224, 64, "Message Service", ["members → devices", "one batched RPC/gateway"])
...
a.box(216, 470, 180, 56, "Sync service", ["GET /v1/sync", "per-device watermark"])
