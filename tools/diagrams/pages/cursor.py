...
s.box(30, 140, 460, 56, "~40 k QPS average, 100 k peak", ["80%+ of inference is wasted — the economic centre"], badge=2)
...
s.box(650, 216, 310, 64, "Should-fire filter, before debounce", ["suppressing 20–40% beats any", "inference optimisation"], badge=5)
