...
a.box(216, 118, 180, 56, "Tweet Service", ["POST /v1/tweets", "Idempotency-Key · Snowflake id"])
...
a.box(216, 502, 180, 64, "Timeline Service", ["GET /v1/timeline?cursor=", "merge · dedupe · cap"])
a.box(430, 502, 180, 64, "Hydration", ["multi-get by id"])
